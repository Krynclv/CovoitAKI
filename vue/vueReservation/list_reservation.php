        ...
        <div class="col-md-4"style="display: flex;">
            ...
            <div class="two">
                ...
                <div class="px-3 pt-3">
                    <h3 class="name">
                        <?php
                        echo "Utilisateurs : ".$ligne['email']."<br>";
                        echo "Utilisateurs : ".$ligne['username']."<br>";
                ...
                <div class="d-flex justify-content-end">
                    ...
                    <a href='index.php?ctl=reservation&action=supprimer&idreservation=<?=$ligne['idreservation']?>&idannonce=<?=$ligne['idannonce']?>'>
